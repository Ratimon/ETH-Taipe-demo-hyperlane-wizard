import type { SharedHypERC20CollateralOptions } from './bridge/2-option-hyp-erc20-collateral';
import type { SharedHypFiatTokenOptions } from './bridge/2-option-hyp-fiat-token';
import type { SharedHypERC4626CollateralOptions } from './bridge/2-option-hyp-erc4626-collateral';
import type { SharedHypERC4626OwnerCollateralOptions } from './bridge/2-option-hyp-erc4626-owner-collateral';
import type { SharedFastHypERC20CollateralOptions } from './bridge/2-option-fast-hyp-erc20-collateral';
import type { SharedHypXERC20Options } from './bridge/2-option-hyp-xerc20';
import type { SharedHypXERC20LockboxOptions } from './bridge/2-option-hyp-xerc20-lockbox';

import type { SharedHypERC20Options } from './bridge/2-option-hyp-erc20';
import type { SharedFastHypERC20Options } from './bridge/2-option-fast-hyp-erc20';

import type { SharedERC20Options} from './bridge/1-option-erc20';
import type { SharedERC4626Options } from './bridge/1-option-erc4626';
import type { SharedXERC20Options } from './bridge/1-option-xerc20';
import type { SharedXERC20LockboxOptions } from './bridge/1-option-xerc20lockbox';
